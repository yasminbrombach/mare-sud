    ...
    <main className="min-h-screen" style={{ background: "#EDE7DC" }}>
      <div className="max-w-md mx-auto min-h-screen" style={{ background: "#FCFAF6" }}>
        <div className="px-5 pt-6 pb-10">
          ...
          <p className="text-xs mb-5" style={{ color: "#6b7280" }}>Ihre Mare Sud Uebersicht</p>
          ...
          {!user && (
            <div className="rounded-2xl px-5 py-6 text-center mb-6" style={{ background: "#E4D6BE" }}>
              ...
              <Link href="/login" className="inline-block text-sm px-5 py-2.5 rounded-full font-medium" style={{ background: "#16283F", color: "#FCFAF6" }}>
                Anmelden
              </Link>
            </div>
          )}
          ...
          <div className="flex rounded-full overflow-hidden border mb-6" style={{ borderColor: "#B8924A" }}>
            {[{ id: "owner", label: "Eigentuemer" }, { id: "provider", label: "Anbieter" }, { id: "agency", label: "Makler" }].map((r) => (
              <button
                key={r.id}
          ...
          {user && (
            <div className="mb-6">
              ...
              {leads.length === 0 && (
                <p className="text-xs" style={{ color: "#9ca3af" }}>Noch keine Anfragen gestellt.</p>
              )}
              {leads.length > 0 && (
          ...
          {[
            ...
            <Link key={item.href} href={item.href} className="flex items-center justify-between py-3 border-b" style={{ borderColor: "rgba(184,146,74,0.15)" }}>
